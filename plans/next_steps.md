 1. Webcam integration. Day by day:
    ...
    3. Debug day for previous 2.
       - Measurements of: camera fps, sampling fps, inference fps, inference latency (time to complete inference in ms)
       - UI for rendering: measurements from 6, textual inference results from camera pipeline; general UI & code cleanup
       - test for best effective sampling fps setup (monodevice for now)
